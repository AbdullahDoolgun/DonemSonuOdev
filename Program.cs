...
namespace DonemSonuOdev
{
    internal class Program
    {
        ...
        {
            string formatHata = "Hay aksi! Sayıyı doğru formatta girin.";
            string notDegeriHata = "Hay aksi! Notu 0-100 aralığında girin.";
            double vizeNotu, finalNotu, notOrtalama, sinifNotOrtalama = 0, enKucuk = 100, enBuyuk = 0;

            Console.Write("Kaç öğrenci kaydetmek istediğinizi giriniz: ");
